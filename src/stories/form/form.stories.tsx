    ...
    children: (
      <>
        <InputField>
          ...
          <Input id="basic_firstName" name="basic_firstName" />
          {error && <Error>{error}</Error>}
        </InputField>

        <InputField className="mt-3">
          <Label htmlFor="basic_lastName">Last Name</Label>
          <Input id="basic_lastName" name="basic_lastName" />
          {error && <Error>{error}</Error>}
        </InputField>
    ...
    children: (
      <>
        <InputField>
          ...
          <Input id="inline_firstName" name="inline_firstName" />
          {error && <Error>{error}</Error>}
        </InputField>

        <InputField className="ml-3">
          <Label htmlFor="inline_lastName">Last Name</Label>
          <Input id="inline_lastName" name="inline_lastName" />
          {error && <Error>{error}</Error>}
        </InputField>
