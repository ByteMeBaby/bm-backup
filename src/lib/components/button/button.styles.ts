...
export const button = cva("cursor-pointer self-start", {
  variants: {
    intent: {
      ...
      secondary:
        "bg-bm_gray-200 text-bm_gray-600 hover:bg-bm_gray-300 hover:text-bm_gray-800 focus-visible:outline focus-visible:outline-bm_gray-300 focus-visible:outline-offset-2",
      success:
